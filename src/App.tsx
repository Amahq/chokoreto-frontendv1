    ...
    <nav className="fixed bottom-0 inset-x-0 bg-white shadow-md flex justify-around py-3 border-t border-pink-200">
      <Link
        ...
        className={`flex flex-col items-center text-sm ${
          isActive("/") ? "text-pink-600 font-bold" : "text-pink-400"
        }`}
      >
      ...
      <Link
        to="/recipes"
        className={`flex flex-col items-center text-sm ${
          isActive("/recipes") ? "text-pink-600 font-bold" : "text-pink-400"
        }`}
      >
      ...
      <Link
        to="/create"
        className={`flex flex-col items-center text-sm ${
          isActive("/create") ? "text-pink-600 font-bold" : "text-pink-400"
        }`}
      >
